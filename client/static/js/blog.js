        ...
        $(window).on('scroll', {
            ...
            function() {
                ...
                if (currentTop < this.previousTop) {
                    //if scrolling up...
                    if (currentTop > 0 && $('.stickyNavContainer').hasClass('is-fixed')) {
                    ...
                    if (currentTop > headerHeight && !$('.stickyNavContainer').hasClass('is-fixed')) $('.stickyNavContainer').addClass('is-fixed');
                }
